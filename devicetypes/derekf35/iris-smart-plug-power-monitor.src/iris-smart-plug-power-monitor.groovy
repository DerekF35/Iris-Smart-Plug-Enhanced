...
metadata {
	...
	definition (name: "Iris Smart Plug - Power Monitor", namespace: "derekf35", author: "Derek Frankhouser") {
		capability "Actuator"
		capability "Switch"
	...
	tiles(scale: 2) {
		...
		valueTile("currentPower", "device.power", key: "SECONDARY_CONTROL", width: 5, height: 1, decoration: "flat") {
		...
		valueTile("displayMode", "command.getDisplayMode", decoration: "flat", width: 5, height: 1){
			state "default", label: 'Display Mode: ${currentValue}'
		}
		...
		details(["switch","currentPower","energyDisplay","resetUsage","power","elapsedTimeDisplay","displayMode","refresh"])
	}
}
